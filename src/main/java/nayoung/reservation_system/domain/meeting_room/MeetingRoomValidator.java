...
public class MeetingRoomValidator {
    ...
    public void existByNumberOfPeople(Long numberOfPeople) {
        if(!meetingRoomRepository.existsByNumberOfPeople(numberOfPeople)) {
            log.warn("[MeetingRoomValidator] " + numberOfPeople + "인원인 Meeting Room은 존재하지 않음");
